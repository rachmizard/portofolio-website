...
export default function Footer() {
     ...
     return (
          <footer
               ref={ref}
               id="footer"
               className="bg-footer-img z-20 bg-no-repeat bg-cover mt-80 w-full h-[351px] px-8 py-4 sm:px-24 flex flex-col lg:flex-row justify-between">
               <div className="mt-20 lg:mt-24 overflow-hidden">
                    <h1
                         className={`text-white font-bold text-4xl sm:text-6xl tracking-wide transition-all hover:text-dark transform duration-1000 ${
