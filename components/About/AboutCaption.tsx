        ...
        <div className="w-8/12 sm:w-10/12 md:w-5/12 space-y-1">
            <ScrollAnimation
                ...
                <p className="text-white font-normal leading-9">
                    I’m currently <span className="font-bold">working</span> as
                    a freelance <span className="font-bold">web developer</span>{' '}
                    and full time{' '}
                    <span className="font-bold">frontend engineer</span>. I
                    really enjoy building web applications using
