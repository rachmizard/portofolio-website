...
export default function Projects() {
     ...
     const websites = projectsData.projects.filter(
          (filter) => filter.type === 'web'
     )

     const mobiles = projectsData.projects.filter(
          (filter) => filter.type === 'mobile'
     )
     ...
     return (
          <section id="projects" className="pt-20 min-h-screen">
               ...
               <div className="mt-5 space-y-4">
                    ...
                    <div className="flex flex-col mx-auto w-10/12 sm:w-8/12 md:w-1/4">
                         <ul className="flex flex-row mb-0 list-none justify-between">
